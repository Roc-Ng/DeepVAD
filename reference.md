...
This is the official repository for the paper titled "**Deep Learning for Video Anomaly Detection: A Review**". 

## 📖 Table of contents

- [Reviews](#reviews)
- [Taxonomy](#taxonomy)
  - [1. Semi-supervised Video Anomaly Detection](#1-unsupervised-video-anomaly-detection)
    ...
    - [1.2 Methodology](#12-Methodology)
      ...
      - [1.2.3 Reasoning/Explainability](#123--Reasoning/Explainability)
...
| Reference                                                                           | #Year | #Venue              | #Main Focus                                | UVAD | WVAD | SVAD | FVAD | OVAD |
|:----------------------------------------------------------------------------------- |:-----:|:-------------------:|:------------------------------------------:|:----:|:----:|:----:|:----:|:----:|
| [Ramachandra et al.](https://ieeexplore.ieee.org/abstract/document/9271895)         | 2020  | IEEE TPAMI          | Semi-supervised single-scene VAD           | ×    | ×    | √    | ×    | ×    |
| [Santhosh et al.](https://dl.acm.org/doi/abs/10.1145/3417989)                       | 2020  | ACM CSUR            | VAD applied on road traffic                | √    | ×    | √    | √    | ×    |
| [Nayak et al.](https://www.sciencedirect.com/science/article/pii/S0262885620302109) | 2021  | IMAVIS              | Deep learning driven semi-supervised VAD   | ×    | ×    | √    | ×    | ×    |
| [Tran et al.](https://dl.acm.org/doi/abs/10.1145/3544014)                           | 2022  | ACM CSUR            | Semi&weakly supervised VAD                 | ×    | ×    | √    | ×    | ×    |
| [Chandrakala et al.](https://link.springer.com/article/10.1007/s10462-022-10258-6)  | 2023  | Artif. Intell. Rev. | Deep model-based one&two-class VAD         | √    | √    | √    | √    | ×    |
| [Liu et al.](https://dl.acm.org/doi/abs/10.1145/3645101)                            | 2023  | ACM CSUR            | Deep Models for semi&weakly supervised VAD | √    | √    | √    | √    | ×    |
| Our survey                                                                          | 2024  | -                   | Comprehensive VAD taxonomy and deep models | √    | √    | √    | √    | √    |

*UVAD=unsupervised VAD, WVAD=weakly supervised VAD, SVAD=semi-supervised VAD, FVAD=fully supervised VAD, OVAD=open-set supervised VAD*
...
- 📄 [Xu et al.](https://www.sciencedirect.com/science/article/abs/pii/S1077314216301618):Detecting anomalous events in videos by learning deep representations of appearance and motion, 📰 `CVIU`
...
- 📄 [ObjectAE](https://openaccess.thecvf.com/content_CVPR_2019/html/Ionescu_Object-Centric_Auto-Encoders_and_Dummy_Anomalies_for_Abnormal_Event_Detection_in_CVPR_2019_paper.html):Object-centric auto-encoders and dummy anomalies for abnormal event detection in video, 📰 `CVPR`

🗓️ **2021**

- 📄 [HF$^2$-VAD](https://openaccess.thecvf.com/content/ICCV2021/html/Liu_A_Hybrid_Video_Anomaly_Detection_Framework_via_Memory-Augmented_Flow_Reconstruction_ICCV_2021_paper):A hybrid video anomaly detection framework via memory-augmented flow reconstruction and flow-guided frame prediction , 📰 `ICCV`

🗓️ **2022**

- 📄 [HSNBM](https://dl.acm.org/doi/abs/10.1145/3503161.3548199):Hierarchical scene normality-binding modeling for anomaly detection in surveillance videos, 📰 `ACM MM`
...
- 📄 [HSC](https://openaccess.thecvf.com/content/CVPR2023/html/Sun_Hierarchical_Semantic_Contrast_for_Scene-Aware_Video_Anomaly_Detection_CVPR_2023_paper):Hierarchical semantic contrast for scene-aware video anomaly detection📰 `CVPR`
...
- 📄 [FSCN](https://www.sciencedirect.com/science/article/abs/pii/S0031320320303186):Fast sparse coding networks for anomaly detection in videos, 📰 `PR`
  
  🗓️ **2021**

- 📄 [F$^2$PN](https://ieeexplore.ieee.org/abstract/document/9622181):Future frame prediction network for video anomaly detection, 📰 `TMAPI`
...
- 📄 [Liu et al.](https://ieeexplore.ieee.org/abstract/document/9746822):Learning task-specific representation for video anomaly detection with spatialtemporal attention, 📰 `ICASSP`
...
- 📄 [Ramachandra et al.](https://openaccess.thecvf.com/content_WACV_2020/html/Ramachandra_Learning_a_distance_function_with_a_Siamese_network_to_localize_WACV_2020_paper.html):Learning a distance function with a siamese network to localize anomalies in videos, 📰 `WACV`
...
- 📄 [Sun et al.](https://dl.acm.org/doi/abs/10.1145/3503161.3548091):Evidential reasoning for video anomaly detection, 📰 `ACM MM`
...
- 📄 [EOGT](https://dl.acm.org/doi/abs/10.1145/3662185):Eogt: Video anomaly detection with enhanced object information and global temporal dependency, 📰 `ACM Trans. Multimedia Comput. Commun. Appl.`

#### 1.2Methodology

##### 1.2.1Self-Supervised Learning
...
- 📄 [SSR-AE](https://ieeexplore.ieee.org/abstract/document/9632460):Self-supervision-augmented deep autoencoder for unsupervised visual anomaly detection, 📰 `IEEE Trans. Cybern.`
...
- 📄 [OGAM and MRAM](https://ieeexplore.ieee.org/abstract/document/9859927):Object-guided and motion-refined attention network for video anomaly detection, 📰 `ICME`
...
- 📄 [AMP-NET](https://ieeexplore.ieee.org/abstract/document/10203018):Amp-net: Appearance-motion prototype network assisted automatic video anomaly detection system, 📰 `TIP`
...
- 📄 [Wang et al.](https://dl.acm.org/doi/abs/10.1145/3394171.3413529):Cluster attention contrast for video anomaly detection, 📰 `ACM MM`
...
- 📄 [Lu et al.](https://ieeexplore.ieee.org/abstract/document/9882128):Learnable locality-sensitive hashing for video anomaly detection, 📰 `TCSVT`

###### Denoising

🗓️ **2020**

- 📄 [Sun et al.](https://ieeexplore.ieee.org/abstract/document/9194323):Adversarial 3d convolutional autoencoder for abnormal event detection in videos , 📰 `TMM`
...
- 📄 [Stacked-RNN](https://openaccess.thecvf.com/content_iccv_2017/html/Luo_A_Revisit_of_ICCV_2017_paper.html), 📰 `ICCV` [code](https://github.com/StevenLiuWen/sRNN_TSC_Anomaly_Detection)
...
- 📄 [RIAD](https://www.sciencedirect.com/science/article/abs/pii/S0031320320305094):Reconstruction by inpainting for visual anomaly detection, 📰 `PR`  [unofficial code](https://github.com/plutoyuxie/Reconstruction-by-inpainting-for-visual-anomaly-detection)
...
- 📄 [AED-MAE](https://openaccess.thecvf.com/content/CVPR2024/html/Ristea_Self-Distilled_Masked_Auto-Encoders_are_Efficient_Video_Anomaly_Detectors_CVPR_2024_paper.html):Self-distilled masked auto-encoders are efficient video anomaly detectors, 📰 `CVPR`
...
- 📄 [AMAE](https://ieeexplore.ieee.org/abstract/document/9739751):Appearance-motion united auto-encoder framework for video anomaly detection , 📰 `IEEE Trans. Circuits Syst. II`
...
- 📄 [Zhang et al.](https://openaccess.thecvf.com/content/CVPR2024/html/Zhang_Multi-Scale_Video_Anomaly_Detection_by_Multi-Grained_Spatio-Temporal_Representation_Learning_CVPR_2024_paper.html):Multi-scale video anomaly detection by multi-grained spatiotemporal representation learning, 📰 `CVPR`
...
- 📄 [Sabokrou Mohammad et al.](https://www.sciencedirect.com/science/article/abs/pii/S1077314218300249):Deep-anomaly: Fully convolutional neural network for fast anomaly detection in crowded scenes, 📰 `CVIU`
...
- 📄 [Sabokrou et al.](https://openaccess.thecvf.com/content_cvpr_2018/html/Sabokrou_Adversarially_Learned_One-Class_CVPR_2018_paper.html):Adversarially learned one-class classifier for novelty detection, 📰 `CVPR`  [code](https://github.com/khalooei/ALOCC-CVPR2018)

- 📄 [AVID](https://link.springer.com/chapter/10.1007/978-3-030-20876-9_31):Avid: Adversarial visual irregularity detection, 📰 `ACCV` [unoffical code](https://github.com/cross32768/AVID-Adversarial-Visual-Irregularity-Detection/tree/master)

🗓️ **2020**

- 📄 [Sabokrou et al.](https://ieeexplore.ieee.org/abstract/document/9059022):Deep end-to-end one-class classifier, 📰 `TNNLS`

- 📄 [Zaheer et al.](https://openaccess.thecvf.com/content_CVPR_2020/html/Zaheer_Old_Is_Gold_Redefining_the_Adversarially_Learned_One-Class_Classifier_Training_CVPR_2020_paper.html):Old is gold: Redefining the adversarially learned one-class classifier training paradigm, 📰 `CVPR`  [code](https://github.com/xaggi/OGNet)

🗓️ **2022**

- 📄 [Zaheer et al.](https://ieeexplore.ieee.org/abstract/document/9887825):Stabilizing adversarially learned one-class novelty detection using pseudo anomalies, 📰 `TIP`

##### 1.2.3 Reasoning/Explainability
...
- 📄 [Doshi and Yilmaz](https://openaccess.thecvf.com/content/WACV2023/html/Doshi_Towards_Interpretable_Video_Anomaly_Detection_WACV_2023_paper.html):Towards interpretable video anomaly detection, 📰 `WACV`
...
- 📄 [LSTM](https://arxiv.org/abs/1612.00390):Anomaly detection in video using predictive convolutional long short-term memory networks, 📰 `arxiv`
...
- 📄 [Sabokrou et al.](https://openaccess.thecvf.com/content_cvpr_2018/html/Sabokrou_Adversarially_Learned_One-Class_CVPR_2018_paper.html):Adversarially learned one-class classifier for novelty detection, 📰 `CVPR`

🗓️ **2020**

- 📄 [Zaheer et al.](https://openaccess.thecvf.com/content_CVPR_2020/html/Zaheer_Old_Is_Gold_Redefining_the_Adversarially_Learned_One-Class_Classifier_Training_CVPR_2020_paper.html):Old is gold: Redefining the adversarially learned one-class classifier training paradigm, 📰 `CVPR`
...
- 📄 [MoCoDAD](https://openaccess.thecvf.com/content/ICCV2023/html/Flaborea_Multimodal_Motion_Conditioned_Diffusion_Model_for_Skeleton-based_Video_Anomaly_Detection_ICCV_2023_paper.html):Multimodal motion conditioned diffusion model for skeleton-based video anomaly detection, 📰 `ICCV`

#### 1.4Model Refinement

##### 1.4.1Pseudo Anomalies

🗓️ **2021**

- 📄 [Astrid Marcella et al.](https://arxiv.org/abs/2110.09742):Learning not to reconstruct anomalies, 📰 `BMVC` [code](https://github.com/aseuteurideu/LearningNotToReconstructAnomalies)
...
- 📄 [Astrid Marcella et al.](https://ieeexplore.ieee.org/abstract/document/9826251):Limiting reconstruction capability of autoencoders using moving backward pseudo anomalies, 📰 `UR`
...
- 📄 [DMAD](https://openaccess.thecvf.com/content/CVPR2023/html/Liu_Diversity-Measurable_Anomaly_Detection_CVPR_2023_paper.html):Diversity-measurable anomaly detection, 📰 `CVPR`
...
- 📄 [Huang et al.](https://dl.acm.org/doi/abs/10.1145/3503161.3548082):Pixel-level anomaly detection via uncertainty-aware prototypical transformer, 📰 `ACM MM`
...
- 📄 [GCLNC+](https://www.sciencedirect.com/science/article/abs/pii/S0925231222000443):Weakly-supervised anomaly detection in video surveillance via graph convolutional label noise cleaning, 📰 `Neurocomputing`
...
- 📄 [LSTC_VAD](https://ieeexplore.ieee.org/abstract/document/10219868):Long-short temporal co-teaching for weakly supervised video anomaly detection , 📰 `ICME`  [code](https://github.com/shengyangsun/LSTC_VAD)
...
- 📄 [DeepMIL](https://openaccess.thecvf.com/content_cvpr_2018/html/Sultani_Real-World_Anomaly_Detection_CVPR_2018_paper.html): Real-world anomaly detectionin surveillance videos, 📰 `CVPR` [homepage](http://crcv.ucf.edu/projects/real-world/)
...
- 📄 [Chang et al.](https://ieeexplore.ieee.org/abstract/document/9540293):Contrastive attention for video anomaly detection, 📰 `TMM`  [code](https://github.com/changsn/Contrastive-Attention-for-Video-Anomaly-Detection)

- 📄 [Purwanto Didik et al.](https://openaccess.thecvf.com/content/ICCV2021/html/Purwanto_Dance_With_Self-Attention_A_New_Look_of_Conditional_Random_Fields_ICCV_2021_paper.html):Dance with self-attention: A new look of conditional random fields on anomaly detection in videos, 📰 `ICCV`
...
- 📄 [Huang et al.](https://ieeexplore.ieee.org/abstract/document/10002867):Weakly supervised video anomaly detection via self-guided temporal discriminative transformer, 📰 `IEEE Trans. Cybern.`
...
- 📄 [Cao et al.](https://ieeexplore.ieee.org/abstract/document/10219658):Weakly supervised video anomaly detection based on cross-batch clustering guidance, 📰 `ICME`
...
- 📄 [CLAWS Net+](https://ieeexplore.ieee.org/abstract/document/10136845):Clustering aided weakly supervised training to detect anomalous events in surveillance videos, 📰 `TNNLS`
...
- 📄 [Liu et al.](https://ieeexplore.ieee.org/abstract/document/10136845):Distilling privileged knowledge for anomalous event detection from weakly labeled videos , 📰 `TNNLS`
...
- 📄 [UCA](https://openaccess.thecvf.com/content/CVPR2024/html/Yuan_Towards_Surveillance_Video-and-Language_Understanding_New_Dataset_Baselines_and_Challenges_CVPR_2024_paper.html):Towards surveillance video-and-language understanding: New dataset baselines and challenges , 📰 `CVPR`
...
- 📄 [Liu et al.](https://dl.acm.org/doi/abs/10.1145/3343031.3350998):Exploring background-bias for anomaly detection in surveillance videos, 📰 `ACM MM`
...
- 📄 [FightNet](https://iopscience.iop.org/article/10.1088/1742-6596/844/1/012044/meta):Violent interaction detection in video based on deep learning, 📰 `Journal of physics: conference series`

🗓️ **2019**

- 📄 [Peixoto Bruno et al.](https://ieeexplore.ieee.org/abstract/document/8682833):Toward subjective violence detection in videos, 📰 `ICASSP`

- 📄 [CCTV-Fights](https://ieeexplore.ieee.org/abstract/document/8683676):Detection of real-world fights in surveillance videos, 📰 `ICASSP`
...
- 📄 [Bruno Peixoto et al.](https://ieeexplore.ieee.org/abstract/document/9054018):Multimodal violence detection in videos, 📰 `ICASSP`
...
- 📄 [Yimeng Shang et al.](https://link.springer.com/chapter/10.1007/978-3-031-18913-5_48):Multimodal violent video recognition based on mutual distillation, 📰 `PRCV`
...
- 📄 [Zaheer et al.](https://openaccess.thecvf.com/content/CVPR2022/html/Zaheer_Generative_Cooperative_Learning_for_Unsupervised_Video_Anomaly_Detection_CVPR_2022_paper.html):Generative cooperative learning for unsupervised video anomaly detection , 📰 `CVPR`
...
- 📄 [MAE](https://openaccess.thecvf.com/content/CVPR2022/html/He_Masked_Autoencoders_Are_Scalable_Vision_Learners_CVPR_2022_paper):Masked autoencoders are scalable vision learners, 📰 `CVPR`

#### 4.3 Others

###### 🗓️ **2021**

- 📄 [Li et al.](https://openaccess.thecvf.com/content/WACV2021/html/Li_Deep_Unsupervised_Anomaly_Detection_WACV_2021_paper.html):Deep unsupervised anomaly detection, 📰 `WACV`
...
- 📄 [Zhu et al.](https://link.springer.com/chapter/10.1007/978-3-031-19830-4_23):Towards open set video anomaly detection, 📰 `ECCV`
...
- 📄 [Few-Shot](https://link.springer.com/chapter/10.1007/978-3-030-58558-7_8):Few-shot scene-adaptive anomaly detection, 📰 `ECCV`  [code](https://github.com/yiweilu3/Few-shot-Scene-adaptive-Anomaly-Detection)

🗓️ **2021**

- 📄 [Hu et al.](https://link.springer.com/chapter/10.1007/978-3-030-88007-1_26):Adaptive anomaly detection network for unseen scene without fine-tuning, 📰 `PRCV`
...
Below are the performance comparison tables for semi-supervised, weakly supervised, violence detection, and unsupervised methods as reported in the literature. For semi-supervised, weakly supervised, and unsupervised methods, the evaluation metric used is AUC%, while for violence detection methods, the metric is Accuracy%.
...
| BMAN       | TIP 2019    | Prediction             | -    | 96.6 | 90     | 76.2         | -        |
...
| STJP       | ECCV 2022   | Jigsaw puzzle          | -    | 99   | 92.2   | 84.3         | 56.4     |
...
| MIST    | CVPR 2021   | I3D(RGB)       | 82.3.     | -           | 94.83        | -     |
